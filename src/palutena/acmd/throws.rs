...
unsafe extern "C" fn palutena_catch(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::CATCH(agent, 1, Hash40::new("top"), 1.8, 0.0, 8.0, 2.2, Some(0.0), Some(8.0), Some(11.2), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_G);
    }
...
unsafe extern "C" fn palutena_catchdash(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::CATCH(agent, 1, Hash40::new("top"), 1.45, 0.0, 8.0, 2.55, Some(0.0), Some(8.0), Some(14.55), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_G);
    }
    macros::game_CaptureCutCommon(agent);
    wait(agent.lua_state_agent, 2.0);
    if macros::is_excute(agent) {
...
unsafe extern "C" fn palutena_catchturn(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::CATCH(agent, 0, Hash40::new("top"), 3.6, 0.0, 8.0, -4.0, Some(0.0), Some(8.0), Some(-18.9), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_G);
        macros::CATCH(agent, 1, Hash40::new("top"), 1.8, 0.0, 8.0, -2.2, Some(0.0), Some(8.0), Some(-20.7), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_G);
    }
    macros::game_CaptureCutCommon(agent);
    wait(agent.lua_state_agent, 2.0);
    if macros::is_excute(agent) {
...
pub fn install() {
    Agent::new("palutena")
        ...
        .game_acmd("game_catchdash", palutena_catchdash, Low)

        .game_acmd("game_catchturn", palutena_catchturn, Low)
