...
// FORWARD TILT 2
unsafe extern "C" fn pit_attacks32(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 10.0);
    if macros::is_excute(agent) {
...
unsafe extern "C" fn pit_effect_attacks32(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 9.0);
    if macros::is_excute(agent) {
        macros::AFTER_IMAGE4_ON_arg29(agent, Hash40::new("tex_pit_sword1"), Hash40::new("tex_pit_sword2"), 4, Hash40::new("swordr1"), 0, 0.9, -0.2, Hash40::new("swordr1"), 0, 11, -1.2, true, Hash40::new("pit_sword"), Hash40::new("swordr1"), 0, 0.9, 0, 0, 90, 0, 1, 0, *EFFECT_AXIS_X, 0, *TRAIL_BLEND_ALPHA, 101, *TRAIL_CULL_NONE, 1.4, 0.1);
    }
    frame(agent.lua_state_agent, 10.0);
    if macros::is_excute(agent) {
        macros::AFTER_IMAGE4_ON_arg29(agent, Hash40::new("tex_pit_sword1"), Hash40::new("tex_pit_sword2"), 3, Hash40::new("swordl"), 0, -0.9, -0.2, Hash40::new("swordl"), 0, -11, -1.2, true, Hash40::new("pit_sword"), Hash40::new("swordl"), 0, -0.9, 0, 180, 90, 0, 1, 0, *EFFECT_AXIS_X, 0, *TRAIL_BLEND_ALPHA, 101, *TRAIL_CULL_NONE, 1.4, 0.1);
...
unsafe extern "C" fn pit_sound_attacks32(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 10.0);
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("se_pit_smash_s01"));
    }
...
pub fn install() {
    Agent::new("pit")
        ...
        .game_acmd("game_attacks32", pit_attacks32, Low)
        .effect_acmd("effect_attacks32", pit_effect_attacks32, Low)
        .sound_acmd("sound_attacks32", pit_sound_attacks32, Low)
        .expression_acmd("expression_attacks32", pit_expression_attacks32, Low)
