...
// DOWN TILT
unsafe extern "C" fn pit_attack_lw3_check_attack_status(fighter: &mut L2CFighterCommon, param_2: &L2CValue, param_3: &L2CValue) -> L2CValue {
...
pub fn install() {
    Agent::new("pit")
        .status(CheckAttack, *FIGHTER_STATUS_KIND_ATTACK_LW3, pit_attack_lw3_check_attack_status)
        .install();
}