...
unsafe extern "C" fn mario_specialn(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn mario_effect_specialairn(agent: &mut L2CAgentBase) {
    let ENTRY_ID = get_entry_id(agent.module_accessor);
...
pub fn install() {
    Agent::new("mario")
        .game_acmd("game_specialn", mario_specialn, Low)
        .effect_acmd("effect_specialn", mario_effect_specialn, Low)
        .sound_acmd("sound_specialn", mario_sound_specialn, Low)
        .game_acmd("game_specialairn", mario_specialn, Low)
        .effect_acmd("effect_specialairn", mario_effect_specialairn, Low)
        .sound_acmd("sound_specialairn", mario_sound_specialn, Low)
