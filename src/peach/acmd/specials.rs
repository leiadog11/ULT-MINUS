...
unsafe extern "C" fn peach_specialairhistart(agent: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("peach")
        .game_acmd("game_specialairhistart", peach_specialairhistart, Low)
