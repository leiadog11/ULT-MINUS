...
unsafe extern "C" fn rob_attack12(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        SoundModule::play_se(agent.module_accessor, Hash40::new("se_system_spirits_level_up"), true, false, false, false, enSEType(0));
